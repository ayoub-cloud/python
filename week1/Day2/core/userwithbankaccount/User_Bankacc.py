...
eya = User("eya","eya@gmail.com")
ayoub = User("ayoub","ayoub@dogmail.com")

ayoub.account.deposit(100)
ayoub.display_account_info()
eya.account.deposit(500)
ayoub.transfer_money(500,eya)
eya.account.deposit(100).withdraw(50).display_account_info()
